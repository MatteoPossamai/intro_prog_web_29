<%@ page contentType="text/html;charset=UTF-8" %>
  ...
  <body>
    ...
    request.getAttribute("usersList", users);
        ...
        Map<String, Integer> visits = (Map<String, Integer>) request.getAttribute("visits");
            int totalVisits = (int) request.getAttribute("totalVisits") ;

-->
    <% String[] simpatizzanti=(String[]) request.getAttribute("simpatizzanti"); %>
      <main class="content">
      ...
      <script>
        ...
        function get(type) {
          ...
          var output = '';
          var simpatizzanti = "${simpatizzanti}";
          var aderenti = "${aderenti}";
