                        ...
                        <tr>
                            <td>
                                <img src="https://www.geometrian.it/wp-content/uploads/2016/12/image-placeholder-500x500.jpg"
                                    alt="immagine progetto 1" height="300px" width="300px"
                                    onclick="checkCheckbox('attivita1')" class="image">
                                <br>
                                <label class="aderente-label" for="attivita1"></label><input type="checkbox"
                                    id="attivita1" name="Attività 1" value="Attività 1">
                            </td>

                            <td>
                                <img src="https://www.geometrian.it/wp-content/uploads/2016/12/image-placeholder-500x500.jpg"
                                    alt="immagine progetto 2" height="300px" width="300px"
                                    onclick="checkCheckbox('attivita2')" class="image">
                                <br>
                                <label class="aderente-label" for="attivita2"></label><input type="checkbox"
                                    id="attivita2" name="Attività 2" value="Attività 2">
                            </td>

                            <td>
                                <img src="https://www.geometrian.it/wp-content/uploads/2016/12/image-placeholder-500x500.jpg"
                                    alt="immagine progetto 3" height="300px" width="300px"
                                    onclick="checkCheckbox('attivita3')" class="image">
                                <br>
                                <label class="aderente-label" for="attivita3"></label><input type="checkbox"
                                    id="attivita3" name="Attività 3" value="Attività 3">
                            </td>
                        </tr>
                    </table>
                    <button type="submit" value="Iscriviti" class="button">Iscriviti</button>
                    <% String[] selected=request.getParameterValues("option"); if (selected !=null) { out.println("Ti sei iscritto alle seguenti attività:");
                        for (String option : selected) { out.println("<li>" +
                        option + "</li>");
                        }
                        } else {
